...
export const TUI_DEFAULTS = {
  ...
  inputMaxLines: 6,
  inputPaddingLines: 2,
  /** Console layout: width of the LCARS button column, in columns. */
  consoleColumnWidth: 22,
  /** Narrowest terminal the console layout draws; below it the classic quadrant is used. */
  consoleMinWidth: 72,
