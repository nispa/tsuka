...
> This document describes the technical architecture, design principles, and modular structure of the **TSUKA** framework (v0.5.0). For codebase contribution guidelines, see [`AGENTS.md`](../AGENTS.md); for completed and upcoming task backlogs, see [`TASKS.md`](../TASKS.md).
>
