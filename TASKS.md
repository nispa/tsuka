...
- [Fase 11 — Seguiti della verifica di sicurezza e della TUI](#fase-11--seguiti-della-verifica-di-sicurezza-e-della-tui-t24) (T24.1 – T24.15)
...
| T22.17 | 🟨 In parte | **Documentazione verificata**: scritta la Tappa 12 delle guide IT/EN (sub-agenti e delega del contesto): meccanismo, contratti `TaskPacket`/`AgentResult`, politica a due soglie, regole di sicurezza e limiti (il padre non si alleggerisce; il figlio riparte dall'obiettivo e dallo stato del workspace). Descrive il comportamento coperto dai test e dichiara che il vantaggio non è misurato. Resta da aggiornare dopo il checkpoint A (T24.3) con i risultati reali. |
